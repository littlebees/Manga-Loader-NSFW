...
var nsfwimp = [{
    name: 'f2mm',
    match: "^https?://www.f2mm.com/beauty/.+/.+",
    img: '#masonry',
    //next: '.a1:last-child',
    next: '',
    toImgs: function(imgArr) {
      return Array.prototype.map.call(imgArr, function(page) { return page.children[0].getAttribute('data-src'); });
    }
},{
    name: 'junmeitu',
